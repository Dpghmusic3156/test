...
<div class="post-share">
    <p class="post-share__heading">Share this article</p>
    <div class="post-share__buttons">
        ...
        <a href="https://twitter.com/intent/tweet?url={{ $share_url }}&text={{ $share_title }}"
           target="_blank" rel="noopener noreferrer"
           class="post-share__btn post-share__btn--tw"
        ...
        <button class="post-share__btn post-share__btn--copy" aria-label="Copy link" onclick="navigator.clipboard.writeText('{{ get_permalink() }}');this.classList.add('copied');setTimeout(()=>this.classList.remove('copied'),2000)">
            ...
            <span class="post-share__copied-msg">Copied!</span>
        </button>
    </div>
</div>
