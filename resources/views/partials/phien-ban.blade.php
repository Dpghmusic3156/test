    ...
    <div class="container mx-auto px-4">
        <div class="grid md:grid-cols-3 gap-8 max-w-7xl mx-auto">
            ...
            <div class="group bg-gradient-to-br from-white to-gray-50 rounded-3xl p-8 border-2 border-gray-200 hover:border-gray-300 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="space-y-3">
                    <a href="{{ home_url('/') }}/dang-ky/" class="block w-full text-center bg-gradient-to-r from-gray-500 to-gray-600 hover:from-gray-600 hover:to-gray-700 text-white font-bold py-3 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl">
                        Đăng ký ngay
                    </a>
                </div>
            </div>
            ...
            <div class="group relative bg-primary-50 rounded-3xl p-8 border-2 border-primary-400 shadow-2xl hover:shadow-3xl transition-all duration-300 hover:-translate-y-2 scale-105" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="space-y-3">
                    <a href="{{ home_url('/') }}/dang-ky/" class="block w-full text-center bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700 text-white font-bold py-3 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl">
                        Đăng ký ngay
                    </a>
                </div>
            </div>
