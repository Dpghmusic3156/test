        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            ...
            <div class="group bg-white rounded-2xl p-8 border border-gray-200 hover:border-primary-300 hover:shadow-xl transition-all duration-300 hover:-translate-y-1" data-aos="fade-up" data-aos-delay="100">
                ...
                <a href="{{ home_url() }}/quan-ly-dieu-phoi/">
                    <h3 class="text-xl font-bold text-gray-800 mb-3 group-hover:text-primary-600 transition-colors cursor-pointer">Quản lý điều phối</h3>
                </a>
                <p class="text-gray-600 leading-relaxed">Dễ dàng điều tiết hàng hoá vào - ra hợp lý. Theo dõi diện trạng sản xuất của các đơn hàng để có kế hoạch hạn chế vấn đề trễ hàng.</p>
            </div>
            ...
            <div class="group bg-white rounded-2xl p-8 border border-gray-200 hover:border-primary-300 hover:shadow-xl transition-all duration-300 hover:-translate-y-1" data-aos="fade-up" data-aos-delay="200">
                ...
                <a href="{{ home_url() }}/quy-trinh-san-xuat/">
                    <h3 class="text-xl font-bold text-gray-800 mb-3 group-hover:text-primary-600 transition-colors cursor-pointer">Quy trình sản xuất</h3>
                </a>
                <p class="text-gray-600 leading-relaxed">Quy trình sản xuất chặt chẽ và thống nhất thông qua mã vạch. Hỗ trợ kiểm soát chất lượng sản phẩm và đánh giá năng lực kỹ thuật viên.</p>
            </div>
            ...
            <div class="group bg-white rounded-2xl p-8 border border-gray-200 hover:border-primary-300 hover:shadow-xl transition-all duration-300 hover:-translate-y-1" data-aos="fade-up" data-aos-delay="300">
                ...
                <a href="{{ home_url() }}/doanh-so-cong-no/">
                    <h3 class="text-xl font-bold text-gray-800 mb-3 group-hover:text-primary-600 transition-colors cursor-pointer">Tài chính - Công nợ</h3>
                </a>
                <p class="text-gray-600 leading-relaxed">Chính xác, tự động và hoàn toàn phù hợp với nghiệp vụ kế toán của Labo. Giảm tối đa khối lượng công việc của kế toán khi xuất hoá đơn cuối tháng.</p>
            </div>
            ...
            <div class="group bg-white rounded-2xl p-8 border border-gray-200 hover:border-primary-300 hover:shadow-xl transition-all duration-300 hover:-translate-y-1" data-aos="fade-up" data-aos-delay="100">
                ...
                <a href="{{ home_url() }}/quan-ly-giao-nhan/">
                    <h3 class="text-xl font-bold text-gray-800 mb-3 group-hover:text-primary-600 transition-colors cursor-pointer">Quản lý giao nhận</h3>
                </a>
                <p class="text-gray-600 leading-relaxed">Hàng đợi các yêu cầu giao / nhận hàng được cập nhật liên tục trên màn hình theo dõi của quản lý giao nhận. Giúp việc quản lý nhân viên giao nhận khoa học hơn.</p>
            </div>
            ...
            <div class="group bg-white rounded-2xl p-8 border border-gray-200 hover:border-primary-300 hover:shadow-xl transition-all duration-300 hover:-translate-y-1" data-aos="fade-up" data-aos-delay="200">
                ...
                <a href="{{ home_url() }}/cham-soc-khach-hang">
                    <h3 class="text-xl font-bold text-gray-800 mb-3 group-hover:text-primary-600 transition-colors cursor-pointer">Chăm sóc khách hàng</h3>
                </a>
                <p class="text-gray-600 leading-relaxed">Toàn bộ dữ liệu và giao dịch liên quan đến khách hàng đều được lưu trữ tập trung. Nhân viên dễ dàng tra cứu toàn bộ các thông tin liên quan đến khách hàng.</p>
            </div>
            ...
            <div class="group bg-white rounded-2xl p-8 border border-gray-200 hover:border-primary-300 hover:shadow-xl transition-all duration-300 hover:-translate-y-1" data-aos="fade-up" data-aos-delay="300">
                ...
                <a href="{{ home_url() }}/bao-cao-tong-hop">
                    <h3 class="text-xl font-bold text-gray-800 mb-3 group-hover:text-primary-600 transition-colors cursor-pointer">Báo cáo tổng hợp</h3>
                </a>
                <p class="text-gray-600 leading-relaxed">Phần mềm có đầy đủ các báo cáo cần thiết để phục vụ nhu cầu theo dõi và quản lý hoạt động của Labo. Đánh giá được năng xuất làm việc của nhân viên.</p>
            </div>
