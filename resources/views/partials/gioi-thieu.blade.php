            ...
            <div class="max-w-2xl mx-auto mb-8">
                <div class="relative group">
                    ...
                    <div class="absolute top-[15%] left-1/2 -translate-x-1/2 text-center pointer-events-none">
                        <div @click="openRegion('north')" class="pointer-events-auto bg-red-500/90 backdrop-blur-md text-white px-5 py-2.5 rounded-full text-sm font-bold shadow-lg cursor-pointer hover:scale-110 transition-transform duration-300 hover:bg-red-600 ring-2 ring-white/30">
                    ...
                    <div class="absolute top-[52%] left-1/2 -translate-x-1/2 text-center pointer-events-none">
                        <div @click="openRegion('central')" class="pointer-events-auto bg-yellow-500/90 backdrop-blur-md text-white px-5 py-2.5 rounded-full text-sm font-bold shadow-lg cursor-pointer hover:scale-110 transition-transform duration-300 hover:bg-yellow-600 ring-2 ring-white/30">
                    ...
                    <div class="absolute bottom-[15%] left-1/2 -translate-x-1/2 text-center pointer-events-none">
                        <div @click="openRegion('south')" class="pointer-events-auto bg-blue-500/90 backdrop-blur-md text-white px-5 py-2.5 rounded-full text-sm font-bold shadow-lg cursor-pointer hover:scale-110 transition-transform duration-300 hover:bg-blue-600 ring-2 ring-white/30">
