...
<div class="bg-gradient-to-b from-gray-50 to-white text-gray-800 relative w-full">
    ...
    {{-- What is vDentalLab Section with Circle Diagram --}}
    <section class="container-block pt-28 pb-8 bg-white relative overflow-hidden min-h-screen flex flex-col justify-center">
            ...
            <div class="container mx-auto px-4">
                <div class="grid lg:grid-cols-2 gap-4 items-center">
                    ...
                    <div class="text-left mb-12 lg:mb-0 lg:pl-40">
                        ...
                        <div class="mt-8">
                            <a href="{{ home_url('/khach-hang') }}" class="inline-flex items-center gap-2 text-accent-500 font-semibold hover:text-accent-600 hover:underline transition-all duration-300">
    ...
    <section class="container-block pt-28 pb-20 bg-gradient-to-br from-primary-600 via-cyan-600 to-primary-700 relative overflow-hidden min-h-screen flex flex-col justify-center">
