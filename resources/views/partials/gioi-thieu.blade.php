        ...
        <div class="container mx-auto px-4">
            ...
            <div class="max-w-2xl mx-auto mb-8">
                <div class="relative group">
                    ...
                    <div class="absolute top-[15%] right-[5%] md:right-[10%] text-center pointer-events-none">
                        <div @click="openRegion('north')" class="pointer-events-auto bg-primary-500/90 backdrop-blur-md text-white px-5 py-2.5 rounded-full text-sm font-bold shadow-lg cursor-pointer hover:scale-110 transition-transform duration-300 hover:bg-primary-600 ring-2 ring-white/30">
                            <span class="inline-block mr-1">🏢</span> Miền Bắc (<span x-text="regions.north.customers.length">0</span>)
                        </div>
                    </div>

                    <div class="absolute top-[52%] right-[5%] md:right-[10%] text-center pointer-events-none">
                        <div @click="openRegion('central')" class="pointer-events-auto bg-accent-500/90 backdrop-blur-md text-white px-5 py-2.5 rounded-full text-sm font-bold shadow-lg cursor-pointer hover:scale-110 transition-transform duration-300 hover:bg-accent-600 ring-2 ring-white/30">
                            <span class="inline-block mr-1">🏢</span> Miền Trung (<span x-text="regions.central.customers.length">0</span>)
                        </div>
                    </div>

                    <div class="absolute bottom-[15%] right-[10%] md:right-[20%] text-center pointer-events-none">
                        <div @click="openRegion('south')" class="pointer-events-auto bg-secondary-500/90 backdrop-blur-md text-white px-5 py-2.5 rounded-full text-sm font-bold shadow-lg cursor-pointer hover:scale-110 transition-transform duration-300 hover:bg-secondary-600 ring-2 ring-white/30">
