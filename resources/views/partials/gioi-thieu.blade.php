    ...
    <section
        ...
        <div class="container mx-auto px-4 relative z-10">
            <div class="max-w-6xl mx-auto">
                ...
                <div class="max-w-6xl mx-auto">
                    <p class="text-lg md:text-xl text-gray-600 leading-relaxed mb-8 text-center max-w-3xl mx-auto">
                    ...
                    <div class="grid lg:grid-cols-2 gap-12 items-center">
                        <div>
                            <div class="flex items-center gap-6 mb-8">
                                ...
                                <h3 class="text-3xl md:text-4xl font-bold text-gray-900 m-0">Quản lý sản xuất chặt chẽ
                                </h3>
                            </div>
                    ...
                    <div class="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div class="order-1 lg:order-2">
                            <div class="flex items-center gap-6 mb-8">
                                ...
                                <h3 class="text-3xl md:text-4xl font-bold text-gray-900 m-0">Nâng cao hiệu quả hoạt động
                                </h3>
                            </div>
                            <ul class="space-y-6 text-gray-600 text-lg md:text-xl">
                                <li class="flex items-start gap-2">
                    ...
                    <div class="grid lg:grid-cols-2 gap-12 items-center">
                        <div>
                            <div class="flex items-center gap-6 mb-8">
                                ...
                                <h3 class="text-3xl md:text-4xl font-bold text-gray-900 m-0">Chăm sóc khách hàng tốt hơn
                                </h3>
                            </div>
                            <ul class="space-y-6 text-gray-600 text-lg md:text-xl">
                                <li class="flex items-start gap-2">
                    ...
                    <div class="text-left mb-12 lg:mb-0 lg:pl-40">
                        ...
                        <div class="mt-8">
                            <a href="{{ home_url('/khach-hang') }}"
                                class="inline-flex items-center gap-2 text-accent-500 font-semibold hover:text-accent-600 hover:underline transition-all duration-300">
