...
<div class="bg-gradient-to-b from-gray-50 to-white text-gray-800 relative h-screen overflow-y-scroll md:snap-y md:snap-mandatory scroll-smooth w-full">
    <section class="relative hero-section bg-gradient-to-br from-primary-600 via-cyan-600 to-primary-700 relative py-24 overflow-hidden min-h-screen flex flex-col justify-center md:snap-start md:snap-always">
    ...
    {{-- What is vDentalLab Section with Circle Diagram --}}
    <section class="py-8 bg-white relative overflow-hidden min-h-screen flex flex-col justify-center md:snap-start md:snap-always">
            ...
            <div class="max-w-6xl mx-auto">
                ...
                <div class="max-w-6xl mx-auto">
                    ...
                    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {{-- Quản lý Khách hàng --}}
                        <div class="group bg-white rounded-3xl p-5 border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                            <div class="mb-3 text-gray-900 group-hover:scale-110 transition-transform duration-300 origin-left">
    ...
    <section class="py-20 bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen flex flex-col justify-center md:snap-start md:snap-always">
    ...
    } elseif (strpos($content_lower, 'tp. hcm') !== false || strpos($content_lower, 'hồ chí minh') !== false || strpos($content_lower, 'ho chi minh') !== false || strpos($content_lower, 'HCM') !== false|| strpos($content_lower, 'sài gòn') !== false || strpos($content_lower, 'saigon') !== false || strpos($content_lower, 'cần thơ') !== false || strpos($content_lower, 'Thủ Đức') !== false|| strpos($content_lower, 'hcm') !== false|| strpos($content_lower, 'can tho') !== false) {
    ...
    <div x-data="{
        ...
        class="min-h-screen flex flex-col justify-center md:snap-start md:snap-always">
                        ...
                        <div class="absolute top-[8%] left-[50%] transform -translate-x-1/2 flex -space-x-3 hover:space-x-1 transition-all duration-300 p-2 z-10"
                            ...
                            <template x-for="(customer, index) in regions.north.customers.slice(0, 3)">
                                <div class="relative w-8 h-8 md:w-10 md:h-10 rounded-full border-2 border-primary-500 bg-white shadow-lg cursor-pointer hover:scale-125 hover:z-20 transition-all duration-300 overflow-hidden group"
                                    :title="customer.name">
                                    <img :src="customer.logo" :alt="customer.name" class="w-full h-full object-cover">
                                    {{-- Tooltip --}}
                                    <div class="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-2 py-1 bg-black/80 text-white text-xs rounded whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none" x-text="customer.name"></div>
                                </div>
                            </template>
                        </div>
