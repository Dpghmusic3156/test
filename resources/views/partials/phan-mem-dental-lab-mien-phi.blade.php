            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="hidden lg:block">
                    <div class="relative rounded-2xl overflow-hidden transform rotate-1 hover:rotate-0 transition-transform duration-500">
                        <img class="w-full h-auto object-cover" src="http://ghuy.me/wp-content/uploads/2025/12/iMac_left-min-6.png" alt="vDentalLab">
                    </div>
                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        form.addEventListener('submit', async function(e) {
            ...
            const pageUrl = 'https://ghuy.me/phan-mem-dental-lab-mien-phi/';
            const apiData = {
                name: data.name,
                url: pageUrl,
                phone: data.phone,
