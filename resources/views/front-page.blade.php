        ...
        <div class="grid lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div class="group relative rounded-[32px] p-8 lg:p-12 overflow-hidden transition-all duration-500 hover:shadow-2xl hover:scale-[1.02]"
                ...
                <div class="relative z-10">
                    <!-- Title -->
                    <h2 class="text-3xl lg:text-4xl font-bold text-white mb-6 leading-tight" data-aos="fade-up">
                        Quản lý toàn diện Dental Lab
                    </h2>
                    ...
                    <div class="space-y-4 mb-10">
                        <div class="flex items-start gap-3">
                            ...
                            <p class="text-white/95 text-base lg:text-lg font-medium leading-relaxed"
                                data-aos="fade-up">
