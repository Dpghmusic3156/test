...
<div x-data="{ showFeaturesModal: false }" class="bg-gradient-to-b from-black-50 to-white text-black-800 relative w-full">
    {{-- Hero Section --}}
    <section class="container-block lg:min-h-screen pt-20 pb-10 px-4 md:px-8 mx-auto md:pt-28 md:pb-20 flex flex-col lg:flex-row items-center justify-between max-w-7xl" data-aos="fade-up">
        <div class="lg:w-1/2 mb-8 lg:mb-0 order-1 lg:order-1 flex flex-col justify-center">
            <div class="inline-flex items-center gap-2 px-4 py-2 bg-primary-100 text-primary-700 rounded-full font-medium text-sm mb-6 w-fit" data-aos="fade-right" data-aos-delay="100">
            ...
            <div class=" leading-tight mb-6" data-aos="fade-right" data-aos-delay="200">
                ...
                <span class="font-medium text-2xl md:text-4xl block text-transparent bg-clip-text bg-gradient-to-r from-primary-500 to-primary-600">Labo Nha Khoa</span>
            </div>
            ...
            <div class="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 mb-8 lg:mb-12" data-aos="fade-right" data-aos-delay="400">
                <a href="{{ home_url('/phan-mem-dental-lab-mien-phi/') }}"
                    class="group relative inline-flex items-center justify-center gap-2 bg-gradient-to-r from-accent-500 to-orange-500 hover:from-accent-600 hover:to-orange-600 text-white font-medium px-10 py-5 rounded-xl transition-all duration-300 shadow-lg shadow-accent-500/30 hover:shadow-2xl hover:shadow-accent-500/50 transform hover:-translate-y-1">
                ...
                <button @click="showFeaturesModal = true"
                    class="inline-flex items-center justify-center gap-2 px-8 py-5 border-2 border-accent-300 text-accent-600 rounded-xl hover:bg-accent-100 hover:border-accent-400 transition-all duration-300 font-medium">
                    ...
                    <div class="m-2 lg:m-4 relative">
                        ...
                        <div class="absolute -bottom-6 -right-6 bg-white p-3 rounded-xl shadow-xl border border-black-100 animate-bounce hidden md:block">
                            <div class="flex items-center gap-2">
                                ...
                                <div>
                                    <p class="text-xs text-black-500">Trạng thái</p>
                                    <p class="font-medium text-black-900 text-sm">Sẵn sàng dùng</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <template x-teleport="body">
        <div x-show="showFeaturesModal"
            ...
            <div x-show="showFeaturesModal"
                ...
                class="fixed inset-0 bg-black-900 bg-opacity-75 transition-opacity"
            ...
            <div class="flex min-h-full items-center justify-center p-4">
                <div x-show="showFeaturesModal"
                    ...
                    {{-- Close Button --}}
                    <button @click="showFeaturesModal = false" class="absolute top-4 right-4 text-black-400 hover:text-black-600 transition">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="text-center mb-8">
                        <h3 class="text-3xl font-semibold text-black-900 mb-2">Chức năng nổi bật</h3>
                        <p class="text-black-600">Giải pháp toàn diện cho Labo Nha khoa</p>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 max-h-[60vh] overflow-y-auto pr-2 custom-scrollbar">
                        ...
                        <div class="flex items-center gap-3 p-4 bg-primary-50 rounded-xl hover:bg-primary-100 transition-all duration-200 group cursor-default">
                            ...
                            <span class="text-black-800 font-medium">Quản lý đơn hàng Labo</span>
                        </div>
                        ...
                        <div class="flex items-center gap-3 p-4 bg-secondary-50 rounded-xl hover:bg-secondary-100 transition-all duration-200 group cursor-default">
                            ...
                            <span class="text-black-800 font-medium">Theo dõi lịch giao hàng</span>
                        </div>
                        ...
                        <div class="flex items-center gap-3 p-4 bg-accent-50 rounded-xl hover:bg-accent-100 transition-all duration-200 group cursor-default">
                            ...
                            <span class="text-black-800 font-medium">Theo dõi sản lượng</span>
                        </div>
                        ...
                        <div class="flex items-center gap-3 p-4 bg-primary-50 rounded-xl hover:bg-primary-100 transition-all duration-200 group cursor-default">
                            ...
                            <span class="text-black-800 font-medium">Phiếu chỉ định</span>
                        </div>
                        ...
                        <div class="flex items-center gap-3 p-4 bg-secondary-50 rounded-xl hover:bg-secondary-100 transition-all duration-200 group cursor-default">
                            ...
                            <span class="text-black-800 font-medium">Hình ảnh đính kèm</span>
                        </div>
                        ...
                        <div class="flex items-center gap-3 p-4 bg-accent-50 rounded-xl hover:bg-accent-100 transition-all duration-200 group cursor-default">
                            ...
                            <span class="text-black-800 font-medium">Công nợ</span>
                        </div>
                        ...
                        <div class="flex items-center gap-3 p-4 bg-primary-50 rounded-xl hover:bg-primary-100 transition-all duration-200 group cursor-default">
                            ...
                            <span class="text-black-800 font-medium">Hoá đơn cuối tháng</span>
                        </div>
                        ...
                        <div class="flex items-center gap-3 p-4 bg-secondary-50 rounded-xl hover:bg-secondary-100 transition-all duration-200 group cursor-default">
                            ...
                            <span class="text-black-800 font-medium">Thu - Chi</span>
                        </div>
                        ...
                        <div class="flex items-center gap-3 p-4 bg-accent-50 rounded-xl hover:bg-accent-100 transition-all duration-200 group cursor-default">
                            ...
                            <span class="text-black-800 font-medium">Doanh số</span>
                        </div>
                        ...
                        <div class="flex items-center gap-3 p-4 bg-primary-50 rounded-xl hover:bg-primary-100 transition-all duration-200 group cursor-default">
                            ...
                            <span class="text-black-800 font-medium">Bảng giá</span>
                        </div>
                        ...
                        <div class="flex items-center gap-3 p-4 bg-secondary-50 rounded-xl hover:bg-secondary-100 transition-all duration-200 group cursor-default">
                            ...
                            <span class="text-black-800 font-medium">Năng suất</span>
                        </div>
                        ...
                        <div class="flex items-center gap-3 p-4 bg-accent-50 rounded-xl hover:bg-accent-100 transition-all duration-200 group cursor-default">
                            ...
                            <span class="text-black-800 font-medium">Hàng lỗi</span>
                        </div>
                        ...
                        <div class="flex items-center gap-3 p-4 bg-primary-50 rounded-xl hover:bg-primary-100 transition-all duration-200 group cursor-default">
                            ...
                            <span class="text-black-800 font-medium">Tiến độ sản xuất</span>
                        </div>
                        ...
                        <div class="flex items-center gap-3 p-4 bg-secondary-50 rounded-xl hover:bg-secondary-100 transition-all duration-200 group cursor-default">
                            ...
                            <span class="text-black-800 font-medium">Hàng trễ</span>
                        </div>
                        ...
                        <div class="flex items-center gap-3 p-4 bg-accent-50 rounded-xl hover:bg-accent-100 transition-all duration-200 group cursor-default">
                            ...
                            <span class="text-black-800 font-medium">Quản lý bằng mã vạch</span>
                        </div>
                    </div>
                </div>
            </div>
