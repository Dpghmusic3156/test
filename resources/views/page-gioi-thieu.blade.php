...
<div class="bg-gradient-to-b from-gray-50 to-white text-gray-800 relative w-full">
    <section
        class="container-block relative hero-section bg-gradient-to-br from-primary-600 via-cyan-600 to-primary-700 relative overflow-hidden min-h-screen flex flex-col justify-center">
        ...
        <div class="container mx-auto px-4 relative z-10">
            <div class="grid lg:grid-cols-2 gap-16 items-center max-w-7xl mx-auto">
                ...
                <div class="relative animate-fade-in-right" x-data="{ showStats: true }"
                    x-init="window.videoModalOpen = false">

                    {{-- Decorative Accent --}}


                    {{-- Video Thumbnail with Play Button --}}
                    <div @click="$dispatch('open-video-modal'); showStats = false"
                        ...
                        <div class="aspect-video rounded-xl overflow-hidden bg-gray-900 relative">
                            {{-- YouTube Thumbnail --}}
                            <img src="https://img.youtube.com/vi/ytoFOidMrhE/maxresdefault.jpg" alt="Video Preview"
                                class="w-full h-full object-cover">

                            {{-- Play Button Overlay --}}
                            <div
                                class="absolute inset-0 flex items-center justify-center bg-black/30 group-hover:bg-black/40 transition-all">
                                <div
                                    class="w-20 h-20 bg-white/90 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform shadow-2xl">
    ...
    <div x-data="{ showModal: false }" @open-video-modal.window="showModal = true"
                ...
                <div x-show="showModal" x-transition:enter="transition ease-out duration-300"
                    ...
                    <div class="aspect-video bg-black flex-shrink-0">
                        <iframe
                            ...
                            class="w-full h-full" title="vDentalLab Video" frameborder="0"
    ...
    <section
        ...
        <div class="container mx-auto px-4 relative z-10">
            <div class="max-w-6xl mx-auto">
                ...
                <div class="max-w-6xl mx-auto">
                    <p class="text-lg md:text-xl text-black leading-relaxed mb-8 text-center max-w-3xl mx-auto">
                        Giải pháp quản trị doanh nghiệp được xây dựng chuyên biệt cho ngành Labo Nha Khoa. Đầy đủ các
                        phân hệ đáp ứng nhu cầu quản lý hoạt động sản xuất, kinh doanh của Labo.
                    </p>
                    ...
                    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {{-- Quản lý Khách hàng --}}
                        <div
                            class="group bg-white rounded-3xl p-5 border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                            <div
                                class="mb-3 text-gray-900 group-hover:scale-110 transition-transform duration-300 origin-left">
                                <svg class="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                                        d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                                </svg>
                            </div>
                            <h3 class="text-xl font-normal text-gray-900 group-hover:text-primary-600 transition-colors">
                        ...
                        <div
                            ...
                            <div
                                ...
                                <svg class="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <line x1="2" y1="10" x2="22" y2="10" stroke-width="1.5" stroke-linecap="round"
    ...
    <section
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="max-w-[1400px] mx-auto">
                <div
                    class="bg-white rounded-3xl p-10 md:px-16 shadow-xl hover:shadow-2xl transition-shadow duration-300">
                    <div class="grid lg:grid-cols-2 gap-12 items-center">
                        <div>
                            <div class="flex items-center gap-6 mb-8">
                                ...
                                <h3 class="text-3xl md:text-4xl font-medium text-gray-900 m-0">Quản lý sản xuất chặt chẽ
                                </h3>
                            </div>
                            <ul class="space-y-6 text-gray-600 text-lg md:text-xl">
                                <li class="flex items-start gap-2">
                                    <span class="text-accent-600 mt-1">✓</span>
                                    <span>Tạo ra môi trường làm việc công bằng hơn khi năng suất được tính toán tự
                                        động</span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <span class="text-accent-600 mt-1">✓</span>
                                    <span>Theo dõi tiến độ sản xuất từng đơn hàng. Kiểm soát chất lượng sản phẩm đầu ra
                                        tại từng công đoạn</span>
                                </li>
                            </ul>
                        </div>
                        <div>
                    ...
                    <div class="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div class="order-1 lg:order-2">
                            <div class="flex items-center gap-6 mb-8">
                                ...
                                <h3 class="text-3xl md:text-4xl font-medium text-gray-900 m-0">Nâng cao hiệu quả hoạt động
                                </h3>
                            </div>
                            <ul class="space-y-6 text-gray-600 text-lg md:text-xl">
                                <li class="flex items-start gap-2">
                                    <span class="text-accent-600 mt-1">✓</span>
                                    <span>Thông tin kết nối giữa các bộ phận trong quy trình hoàn chỉnh từ nhận mẫu đến
                                        giao hàng</span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <span class="text-accent-600 mt-1">✓</span>
                                    <span>Kiểm soát hàng lỗi; Xác định nguyên nhân lỗi do công đoạn nào, kỹ thuật viên
                                        nào gây ra</span>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="grid lg:grid-cols-2 gap-12 items-center">
                        <div>
                            <div class="flex items-center gap-6 mb-8">
                                ...
                                <h3 class="text-3xl md:text-4xl font-medium text-gray-900 m-0">Chăm sóc khách hàng tốt hơn
                                </h3>
                            </div>
                            <ul class="space-y-6 text-gray-600 text-lg md:text-xl">
                                <li class="flex items-start gap-2">
                                    <span class="text-accent-600 mt-1">✓</span>
                                    <span>Kho dữ liệu tập trung từ tất cả các bộ phận: sản xuất, tài chính, bảo hành...
                                        Giúp dễ dàng tra cứu và giải đáp ngay các thắc mắc của khách hàng</span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <span class="text-accent-600 mt-1">✓</span>
                                    <span>Phần mềm giúp giảm thiểu tối đa các đơn hàng trễ, thất lạc; Tránh các sai sót
                                        trong khâu tài chính, công nợ</span>
                                </li>
                            </ul>
                        </div>
                        <div>
    ...
    if (strpos($content_lower, 'hà nội') !== false || strpos($content_lower, 'ha noi') !== false ||
    strpos($content_lower, 'hanoi') !== false) {
    $regions_data['north']['customers'][] = $customer;
    } elseif (strpos($content_lower, 'tp. hcm') !== false || strpos($content_lower, 'hồ chí minh') !== false ||
    strpos($content_lower, 'ho chi minh') !== false || strpos($content_lower, 'HCM') !== false|| strpos($content_lower,
    'sài gòn') !== false || strpos($content_lower, 'saigon') !== false || strpos($content_lower, 'cần thơ') !== false ||
    strpos($content_lower, 'Thủ Đức') !== false|| strpos($content_lower, 'hcm') !== false|| strpos($content_lower, 'can
    tho') !== false) {
                ...
                <div class="grid lg:grid-cols-2 gap-4 items-center">
                    ...
                    <div class="text-left mb-12 lg:mb-0 lg:pl-40">
                        ...
                        <p class="text-lg text-gray-600 mb-8 leading-relaxed">
                            Nhiệm vụ của chúng tôi là mang đến công cụ quản lý hiệu quả cho tất cả Labo. Xin cảm ơn
                            những khách hàng đã sử dụng phần mềm của chúng tôi!
                        </p>
                        <div class="mt-8">
                            <a href="{{ home_url('/khach-hang') }}"
                                class="text-lg inline-flex items-center gap-2 text-accent-500 hover:text-accent-600 hover:underline transition-all duration-300">
                                <span>Cùng nhiều khách hàng khác</span>
                            ...
                            <svg width="100%" height="auto" viewBox="0 0 800 800" fill="none"
                                ...
                                <g transform="translate(180, 0)">
                                    ...
                                    <path @click="openRegion('south')"
                                        ...
                                        fill="#06b6d4" fill-opacity="0.7">
                                        <title>Miền Nam - Click để xem khách hàng</title>
                                    </path>

                                    {{-- Paracel Islands (Hoàng Sa) - Star Icon --}}
                                    <g transform="translate(450, 240) scale(1.5)">
                                        <path
                                            d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"
                                            fill="#f59e0b" stroke="none">
                                            <title>Quần đảo Hoàng Sa</title>
                                        </path>

                                    </g>

                                    {{-- Spratly Islands (Trường Sa) - Star Icon --}}
                                    <g transform="translate(480, 550) scale(1.5)">
                                        <path
                                            d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"
                                            fill="#f59e0b" stroke="none">
                                            <title>Quần đảo Trường Sa</title>
                                        </path>
                                ...
                                <template x-for="(customer, index) in regions.north.customers.slice(0, 3)">
                                    <div class="relative w-[19%] md:w-[17%] aspect-square rounded-full border-2 border-primary-500 bg-white shadow-lg cursor-pointer md:hover:scale-125 md:hover:z-20 transition-all duration-300 overflow-hidden group"
                                        ...
                                        <img :src="customer.logo" :alt="customer.name"
                                            class="w-full h-full object-cover">
                                        {{-- Tooltip --}}
                                        <div class="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-2 py-1 bg-black/80 text-white text-xs rounded whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none"
            ...
            <div x-show="showModal" x-transition:enter="transition ease-out duration-300"
                ...
                <div x-show="showModal" x-transition:enter="transition ease-out duration-300"
                    ...
                    <div class="p-8 overflow-y-auto max-h-[calc(80vh-180px)]">
                        ...
                        <template
                            x-if="selectedRegion && (!regions[selectedRegion]?.customers || regions[selectedRegion]?.customers.length === 0)">
    ...
    <section
        class="container-block pt-28 pb-20 bg-gradient-to-br from-primary-600 via-cyan-600 to-primary-700 relative overflow-hidden min-h-screen flex flex-col justify-center">
