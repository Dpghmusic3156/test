<footer class="content-info w-full py-14">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 pt-10 pb-10">
            <div class="col-span-1 sm:col-span-2 lg:col-span-2 mb-10 lg:mb-0">
                <div class="flex justify-center lg:justify-start mb-1">
                    <a href="https://phanmemlabo.com/" class="flex justify-center lg:justify-start">
                        <img src="http://localhost:8080/test/wp-content/uploads/2025/12/cropped-logo_chim_newAsset-2.png"
                            alt="vDentalLab Logo" class="h-10">
                    </a>
                    <a href="https://phanmemlabo.com/" class="flex items-center ml-2 text-gray-800 font-bold text-2xl">
                        vDentalLab
                    </a>
                </div>
            ...
            <div class="text-left">
                ...
                <ul class="text-sm  transition-all duration-500">
                    ...
                    <li class="mb-6"><a href="tel:0947476000"
                            class="flex items-center gap-3 text-gray-600 hover:text-pmlab-primary1">
                            <i class="fas fa-phone-alt"></i>
                            <span>0947476000</span>
                        </a></li>
            ...
            <div class="text-left">
                ...
                <ul class="text-sm  transition-all duration-500">
                    <li class="mb-6"><a href="javascript:;" class="text-gray-600 hover:text-pmlab-primary1">Điều phối
                            hoạt
                            động</a></li>
                    <li class="mb-6"><a href="javascript:;" class=" text-gray-600 hover:text-pmlab-primary1">Quy trình
                            sản
                            xuất</a>
                    </li>
                    <li class="mb-6"><a href="javascript:;" class=" text-gray-600 hover:text-pmlab-primary1">Tài chính –
                            Công
                            nợ</a></li>
                    <li class="mb-6"><a href="javascript:;" class=" text-gray-600 hover:text-pmlab-primary1">Quản lý
                            giao
                            nhận</a></li>
                    <li class="mb-6"><a href="javascript:;" class=" text-gray-600 hover:text-pmlab-primary1">Chăm sóc
                            khách
                            hàng</a>
                    </li>
                    <li class="mb-6"><a href="javascript:;" class=" text-gray-600 hover:text-pmlab-primary1">Báo cáo
                            kinh
                            doanh</a>
                    </li>
                </ul>
