    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="max-w-4xl mx-auto text-center text-white">
            ...
            <p class="text-lg md:text-xl text-white/90 leading-relaxed mb-8 max-w-3xl mx-auto" data-aos="fade-up"
                data-aos-delay="200">
                Giải pháp toàn diện với đầy đủ các phân hệ quản lý, từ điều phối sản xuất, tài chính đến chăm sóc khách
                hàng
            </p>
...
<section class="py-20 bg-white" data-aos="fade-up">
    <div class="container mx-auto px-4">
        ...
        <div class="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {{-- Advantage 1 --}}
            <div class="group bg-gradient-to-br from-white to-gray-50 rounded-2xl p-8 border border-gray-200 hover:border-teal-300 hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            ...
            <div class="group bg-white rounded-2xl p-8 border border-gray-200 hover:border-primary-300 hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
                ...
                <p class="text-gray-600 leading-relaxed">Dễ dàng điều tiết hàng hoá vào - ra hợp lý. Theo dõi diện trạng
                    sản xuất của các đơn hàng để có kế hoạch hạn chế vấn đề trễ hàng.</p>
            </div>
            ...
            <div class="group bg-white rounded-2xl p-8 border border-gray-200 hover:border-primary-300 hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
                ...
                <p class="text-gray-600 leading-relaxed">Quy trình sản xuất chặt chẽ và thống nhất thông qua mã vạch. Hỗ
                    trợ kiểm soát chất lượng sản phẩm và đánh giá năng lực kỹ thuật viên.</p>
            </div>
            ...
            <div class="group bg-white rounded-2xl p-8 border border-gray-200 hover:border-primary-300 hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
                ...
                <p class="text-gray-600 leading-relaxed">Chính xác, tự động và hoàn toàn phù hợp với nghiệp vụ kế toán
                    của Labo. Giảm tối đa khối lượng công việc của kế toán khi xuất hoá đơn cuối tháng.</p>
            </div>
            ...
            <div class="group bg-white rounded-2xl p-8 border border-gray-200 hover:border-primary-300 hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
                ...
                <p class="text-gray-600 leading-relaxed">Hàng đợi các yêu cầu giao / nhận hàng được cập nhật liên tục
                    trên màn hình theo dõi của quản lý giao nhận. Giúp việc quản lý nhân viên giao nhận khoa học hơn.
                </p>
            </div>
            ...
            <div class="group bg-white rounded-2xl p-8 border border-gray-200 hover:border-primary-300 hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
                ...
                <p class="text-gray-600 leading-relaxed">Toàn bộ dữ liệu và giao dịch liên quan đến khách hàng đều được
                    lưu trữ tập trung. Nhân viên dễ dàng tra cứu toàn bộ các thông tin liên quan đến khách hàng.</p>
            </div>
            ...
            <div class="group bg-white rounded-2xl p-8 border border-gray-200 hover:border-primary-300 hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
                ...
                <p class="text-gray-600 leading-relaxed">Phần mềm có đầy đủ các báo cáo cần thiết để phục vụ nhu cầu
                    theo dõi và quản lý hoạt động của Labo. Đánh giá được năng xuất làm việc của nhân viên.</p>
            </div>
