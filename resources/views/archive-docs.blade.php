...
<section class="banner-section relative bg-cover"
  ...
  <div class="container">
    <div class="banner-content h-96 flex flex-col items-center justify-center text-center mx-auto relative">
      ...
      <div class="flex justify-center w-full px-4 md:px-0 md:w-1/2">
        {{-- Tìm kiếm tài liệu --}}
...
<div class="container mx-auto py-10">
  ...
  <div class="flex flex-wrap justify-center gap-6 mt-10 max-w-6xl mx-auto">
    ...
    @endphp
    <div class="bg-white border border-gray-100 rounded-2xl shadow hover:shadow-lg transition p-6 flex flex-col group sm:w-[calc(50%-12px)] md:w-[calc(33.333%-16px)]" style="width: 100%; max-width: 380px;">
