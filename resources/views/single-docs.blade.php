                    ...
                    <li class="mb-2" x-data="{ open: {{ $is_current_cat ? 'true' : 'false' }} }">
                        <div class="flex items-center group">
                            ...
                            <a
                                ...
                                class="font-semibold text-gray-700 group-hover:text-primary-600 transition-colors flex-1 {{ $is_current_cat ? 'text-primary-600' : '' }}"
                        ...
                        <ul x-show="open" x-transition class="ml-6 mt-2 border-l border-gray-100 pl-3 space-y-1">
                            ...
                            {{ get_the_ID() == $post->ID ? 'bg-primary-100 text-primary-600 font-bold' : 'text-gray-600 hover:bg-gray-100 hover:text-primary-600' }}">
                                    {{ get_the_title($post) }}
                                </a>
                            </li>
                            @endforeach
